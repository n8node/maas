  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-bg3 px-6 py-12">
      <div className="w-full max-w-sm rounded-lg border border-border bg-bg p-6 shadow-sm">
        ...
        <h1 className="mt-1 text-lg font-medium text-ink">Create account</h1>
        <p className="mt-2 text-sm text-subtle">Public sign-up creates a user account. Superadmin is provisioned via CLI only.</p>
