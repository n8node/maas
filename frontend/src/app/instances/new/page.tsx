...
import { InstancesNew } from "@/components/instances/InstancesNew";
import { meRequest, type MeUser } from "@/lib/api";
import { clearToken, getToken } from "@/lib/token";

export default function InstancesNewPage() {
  ...
  if (!user) {
    return (
      <main className="flex min-h-screen flex-col items-center justify-center gap-3 bg-bg3 px-6">
        <p className="text-sm text-muted">Sign in to create an instance.</p>
